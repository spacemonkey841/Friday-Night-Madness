	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?noteType:Int = 0)
		{
			...
			switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						var fuckingSussy = Paths.getSparrowAtlas('warning');
						...
						switch(noteType)
						{
							case 2:
							{
								frames = Paths.getSparrowAtlas('warning');
								...
								animation.addByPrefix('purpleholdend', 'warning');
								animation.addByPrefix('greenholdend', 'warning');
								animation.addByPrefix('redholdend', 'warning');
								animation.addByPrefix('blueholdend', 'warning');
 
								animation.addByPrefix('purplehold', 'warning');
								animation.addByPrefix('greenhold', 'warning');
								animation.addByPrefix('redhold', 'warning');
								animation.addByPrefix('bluehold', 'warning');
